...
module.exports = {
    ...
    brand: {
        ...
        site: {
            ...
            landingTitle: 'Speakeasy — members only',
            newCallTitle: 'Speakeasy — members only',
            newCallRoomTitle: 'Name your hideout. <br />Pass the word. <br />Let them in.',
            newCallRoomDescription:
                "Every hideout gets its own one-time door. Name it, share the link, and let the right folks in.",
            ...
            clientTitle: 'Speakeasy — in session',
            privacyPolicyTitle: 'Speakeasy — house rules',
            stunTurnTitle: 'Test Stun/Turn Servers.',
            notFoundTitle: 'Speakeasy — lost your way?',
            waitingRoomTitle: 'Speakeasy — hold tight, the host is on the way',
            waitingRoomHeading: 'Hold tight at the door...',
            waitingRoomDescription:
                "The host hasn't opened up yet.<br />Sit tight — you'll slip in the moment the door swings open.",
            waitingRoomStatus: 'Checking the door...',
            waitingRoomReady: "Door's open — slipping you in...",
            waitingRoomWaiting: 'Waiting for the host to unlock the door...',
            waitingRoomHostLink: 'Run this joint?',
            waitingRoomLoginLink: 'Slip in here',
            waitingRoomElapsedJust: 'Just pulled up',
            waitingRoomElapsedMinutes: 'At the door for {minutes}',
            waitingRoomSongUrl: '../sounds/waiting-music-speakeasy.mp3',
        },
        html: {
            topSponsors: false,
            features: true,
    ...
    themes: {
        ...
        dark: {
            ...
            '--msger-private-bg': 'radial-gradient(#1E1A15, #14110E)',
            '--wb-bg': 'radial-gradient(#1E1A15, #14110E)',
            '--elem-border-color': '1px solid rgba(212, 175, 55, 0.18)',
            '--navbar-bg': 'rgba(20, 17, 14, 0.88)',
            '--select-bg': '#241F18',
            '--tab-btn-active': '#3A3122',
            '--box-shadow': '0px 4px 12px 0px rgba(0, 0, 0, 0.55)',
            '--left-msg-bg': '#2A2118',
            '--right-msg-bg': '#3A3122',
            '--private-msg-bg': '#241F18',
            '--btn-bar-bg-color': '#D4AF37',
            '--btn-bar-color': '#14110E',
            '--btns-bg-color': 'rgba(20, 17, 14, 0.78)',
            '--dd-color': '#D4AF37',
        },
